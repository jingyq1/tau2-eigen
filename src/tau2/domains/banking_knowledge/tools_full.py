...
def is_discoverable_tool(tool_type: ToolType = ToolType.READ, mutates_state: Optional[bool] = None):
    if mutates_state is None:
        mutates_state = tool_type == ToolType.WRITE
...
def generate_user_discoverable_tool_call_id(tool_name: str, arguments: Dict[str, Any]) -> str:
...
def generate_agent_discoverable_tool_call_id(tool_name: str, arguments: Dict[str, Any]) -> str:
    seed = f"agent_discoverable_tool_call:{tool_name}:{json.dumps(arguments, sort_keys=True)}"
    return _deterministic_id(seed, length=16)


def generate_credit_card_order_id(credit_card_account_id: str, user_id: str, reason: str) -> str:
...
def generate_account_flag_id(credit_card_account_id: str, flag_type: str, expiration_date: str) -> str:
...
def generate_debit_card_order_id(account_id: str, user_id: str, delivery_option: str) -> str:
